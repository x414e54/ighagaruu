...
#include"Tokenizer.h"
Tokenizer::Tokenizer(std::wstring string, wchar_t delimiter)
{
	currentString=string;
	currentDelimiter=delimiter;
}
Tokenizer::Tokenizer(std::wstring string, unsigned int offset, wchar_t delimiter)
{
	currentString=string.substr(offset,string.size());
	currentDelimiter=delimiter;
}
Tokenizer::~Tokenizer(){
}
