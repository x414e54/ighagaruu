...
namespace nv_dds
{
    ...
    // dwCaps2 flags
    const DWORD DDSF_CUBEMAP         = 0x00000200l;
    const DWORD DDSF_CUBEMAP_POSITIVEX  = 0x00000400l;
    const DWORD DDSF_CUBEMAP_NEGATIVEX  = 0x00000800l;
    const DWORD DDSF_CUBEMAP_POSITIVEY  = 0x00001000l;
    const DWORD DDSF_CUBEMAP_NEGATIVEY  = 0x00002000l;
    const DWORD DDSF_CUBEMAP_POSITIVEZ  = 0x00004000l;
    const DWORD DDSF_CUBEMAP_NEGATIVEZ  = 0x00008000l;
    const DWORD DDSF_CUBEMAP_ALL_FACES  = 0x0000FC00l;
    const DWORD DDSF_VOLUME          = 0x00200000l;

    // compressed texture types
    const DWORD FOURCC_DXT1 = 0x31545844l; //(MAKEFOURCC('D','X','T','1'))
    const DWORD FOURCC_DXT3 = 0x33545844l; //(MAKEFOURCC('D','X','T','3'))
    const DWORD FOURCC_DXT5 = 0x35545844l; //(MAKEFOURCC('D','X','T','5'))
